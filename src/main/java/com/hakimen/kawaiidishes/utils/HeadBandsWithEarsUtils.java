...
public class HeadBandsWithEarsUtils {
    ...
    public static void makeHeadbandWithEars(AnimalType type, IAnimationPredicate<HeadBandWithEarsArmorItem> state, DeferredHolder<Item, HeadBandWithEarsArmorItem> item) {
        ...
        earedHeadBandsModels.put(type, new HeadBandsWithEarsModel(
                ResourceLocation.fromNamespaceAndPath(KawaiiDishes.MODID, "geo/head_bands_with_ears/head_band_%s_ears.geo.json".formatted(typeName)),
                ResourceLocation.fromNamespaceAndPath(KawaiiDishes.MODID, "textures/models/armor/head_bands_with_ears/head_bands/%s/head_band.png".formatted(typeName)),
                ResourceLocation.fromNamespaceAndPath(KawaiiDishes.MODID, "animations/ears/%s_ears.animation.json".formatted(typeName))
        ));

        earedHeadBandsEarsBase.put(type, ResourceLocation.fromNamespaceAndPath(KawaiiDishes.MODID, "textures/models/armor/head_bands_with_ears/ears_base/%s_ears.png".formatted(typeName)));
        earedHeadBandsEarsOverlay.put(type, ResourceLocation.fromNamespaceAndPath(KawaiiDishes.MODID, "textures/models/armor/head_bands_with_ears/ears_overlays/%s_ears.png".formatted(typeName)));
        earedHeadBandsEarsSkin.put(type, ResourceLocation.fromNamespaceAndPath(KawaiiDishes.MODID, "textures/models/armor/head_bands_with_ears/ears_skin/%s_ears.png".formatted(typeName)));
