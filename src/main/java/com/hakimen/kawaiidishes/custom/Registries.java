...
//    public static final ResourceKey<Registry<Aroma>> AROMA_REGISTRY_KEY = ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(KawaiiDishes.MODID, "aromas"));
