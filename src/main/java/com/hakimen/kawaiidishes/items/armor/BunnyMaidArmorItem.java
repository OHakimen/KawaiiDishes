...
public class BunnyMaidArmorItem extends GeoArmorItem implements IAnimatable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);
    public String textureLocation;

    public BunnyMaidArmorItem(String textureName, Item dress) {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<BunnyMaidArmorItem>(this,"controller",0, this::predicate));
    }
    @Override
    public void onArmorTick(ItemStack stack, Level level, Player player) {
        ...
        if(player.getInventory().getArmor(EquipmentSlot.CHEST.getIndex()).getItem() instanceof BunnyMaidArmorItem){
